...
public class EventDao extends AbstractDao<Event, Long> {
    ...
    private Query<Event> season_EventListQuery;
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"EVENT\" (" + //
                ...
                "\"NAME\" TEXT," + // 2: name
                "\"SEASON_ID\" INTEGER NOT NULL ," + // 3: season_id
                "\"DATA\" TEXT," + // 4: data
                "\"DATE\" INTEGER," + // 5: date
    ...
    protected final void bindValues(DatabaseStatement stmt, Event entity) {
        ...
        stmt.bindLong(4, entity.getSeason_id());
    ...
    public Event readEntity(Cursor cursor, int offset) {
        Event entity = new Event( //
                ...
                cursor.getLong(offset + 3), // season_id
    ...
    public void readEntity(Cursor cursor, Event entity, int offset) {
        ...
        entity.setSeason_id(cursor.getLong(offset + 3));
    ...
    /** Internal query to resolve the "eventList" to-many relationship of Season. */
    public List<Event> _querySeason_EventList(long season_id) {
        synchronized (this) {
            if (season_EventListQuery == null) {
                QueryBuilder<Event> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.Season_id.eq(null));
                season_EventListQuery = queryBuilder.build();
            }
        }
        Query<Event> query = season_EventListQuery.forCurrentThread();
    ...
    public static class Properties {
        ...
        public final static Property Season_id = new Property(3, long.class, "season_id", false, "SEASON_ID");
