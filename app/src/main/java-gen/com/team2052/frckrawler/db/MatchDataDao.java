...
public class MatchDataDao extends AbstractDao<MatchData, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MatchData entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MatchData entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(MatchData entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(MatchData entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(MatchData entity) {
