...
import com.team2052.frckrawler.activity.dialog.CommentDialogActivity;
import com.team2052.frckrawler.activity.dialog.QuerySortingDialogActivity;
...
public class SummaryActivity extends StackableTabActivity implements OnClickListener {
    ...
    private class GetCompiledDataTask extends AsyncTask
        ...
        protected Void doInBackground(SummaryActivity... params) {
            ...
            //Add all the addbutton names to the descriptors row, but
