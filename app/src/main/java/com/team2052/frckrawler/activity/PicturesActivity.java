...
import com.team2052.frckrawler.activity.dialog.ImportImageDialogActivity;
...
public class PicturesActivity extends StackableTabActivity implements OnClickListener {
     ...
     * @param reqWidth
     * @param reqHeight
     * @return Summary: Gets a Bitmap object from an image file. Uses the specified width
     * and height.
     * ***
     */
     ...
     *
     * @return Summary: gets the file where the robot's image is to be stored.
     */
