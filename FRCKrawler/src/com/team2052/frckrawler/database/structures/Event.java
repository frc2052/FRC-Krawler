...
public class Event implements Structure {
	...
	public Event(String _eventName, String _gameName, 
			Date _dateStamp, String _location, String fmsID) {
		
		this(-1, _eventName, _gameName, _dateStamp, _location,  fmsID);
	}
	
	public Event(int _eventID, String _eventName, String _gameName, 
			Date _dateStamp, String _location, String _fmsID) {
